			...
			<div className="flex-1 flex flex-col text-xl gap-16 min-h-0">
				...
				<div className="flex w-full flex-col items-center gap-16 p-4 md:flex-row">
					<p className="w-full md:w-1/2">
						...
						where players, creators, and fans come together to share their
						passion for all things gaming. Whether you're into casual party
						games, competitive esports, or exploring virtual worlds, our club
						has a place for you.
					</p>
					<img
						src="/images/gg1.jpg"
				...
				<div className="flex w-full flex-col items-center gap-16 p-4 md:flex-row">
					...
					<p className="w-full md:w-1/2">
						...
						tournaments, in-person game nights, and community scrims. It’s a
						space to connect, compete, and just have fun with fellow students
						who love gaming as much as you do.
					</p>
				</div>
				<div className="flex w-full flex-col items-center gap-16 p-4 md:flex-row">
					<p className="w-full md:w-1/2">
						No matter your skill level or favorite genre, our goal is to build
						an inclusive and energetic gaming community on campus.
					</p>
					<img
						src="/images/gg3.JPG"
						alt=""
